...
* Sample mass: 5 mg +/- 0.20 mg
  - Initial sample mass corresponds to the mass measured in the STA instrument prior to the initial isotherm.
  - The STA instrument records mass changes as m/m₀ [%] with a balance resolution of 0.1 µg.
...
* Note
  - The first and second two measurements at heating rate of 5 K/min were taken on a different day. The difference in TGA data may be caused by different humidity levels. MLR data in the main part of thermal decomposition used for calibration are not affected.
