...
A total of 59 DSC datasets were submitted by seven institutions. All DSC measurements were obtained as part of simultaneous thermal analysis (STA), with thermogravimetric and heat-flow data recorded during the same experiment. Of these measurements, 41 tests were conducted in pure nitrogen at nominal heating rates between 3 and 50~K/min, with the largest number of 16 measurements obtained at 10~K/min. A further 18 tests were conducted at various heating rates in oxidative atmospheres containing 3--21~\% oxygen in nitrogen.
