...
\caption{Measured spectral reflectivity of `MaCFP Wood' and corresponding char samples. The upper panel shows the average reflectivity of the virgin wood measured by participating institutions, while the lower panel shows the reflectivity of char samples produced under different heating conditions.}
